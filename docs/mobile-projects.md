...
Header follow-up: Film, Music and Info now each have a minimum 44×44px mobile tap area, with additional separation. The shared navigation applies this consistently to Info, project pages, press pages and Recording Parties, preserving the approved type size. Checked all four active page types at 320, 375, 390, 430 and 760px widths without overlap or horizontal overflow.
