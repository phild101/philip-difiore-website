...
- Optional header comparison: `?header=bold#info` uses DM Sans 700 for the name and navigation only, across Film, Music and Info. Existing font sizes, spacing and colors remain. The default link without `header=bold` keeps Courier New 400; Philip may revert and has not chosen the new font as default.
