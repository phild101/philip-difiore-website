...
- Music contains Recording Parties. Clicking its existing artwork opens a spare black-and-white archive: party selector, four-photo manual viewer with a signature color wash per party, seven recordings across three parties, attendees, and a compact Bedford + Bowery press link. Party choices have shareable `?party=2` URLs; photo browsing preserves playback.
